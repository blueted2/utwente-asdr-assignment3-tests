...
void ControllerPanTilt::CopyInputsToVariables (XXDouble *u)
{
...
void ControllerPanTilt::CopyVariablesToOutputs (XXDouble *y)
{
...
ControllerPanTilt::ControllerPanTilt(void)
{
...
void ControllerPanTilt::Reset(XXDouble starttime)
{
...
bool ControllerPanTilt::IsFinished(void)
{
...
void ControllerPanTilt::Initialize (XXDouble *u, XXDouble *y, XXDouble t)
{
...
void ControllerPanTilt::Calculate (XXDouble *u, XXDouble *y /*, XXDouble t*/)
{
	switch (state)
	{
...
void ControllerPanTilt::Terminate (XXDouble *u, XXDouble *y /*, XXDouble t */)
{
	/* copy the inputs */
	CopyInputsToVariables (u);
 ...
 */
void ControllerPanTilt::CalculateInitial (void)
{
 ...
 */
void ControllerPanTilt::CalculateStatic (void)
{
 ...
 */
void ControllerPanTilt::CalculateInput (void)
{
 ...
 */
void ControllerPanTilt::CalculateDynamic (void)
{
 ...
 */
void ControllerPanTilt::CalculateOutput (void)
{
 ...
 * are performed
 */
void ControllerPanTilt::CalculateFinal (void)
{
...
bool ControllerPanTilt::SetFinishTime(XXDouble newtime)
{
