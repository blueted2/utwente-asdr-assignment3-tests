...
/* XXDelay is model specific and therefore implemented in ControllerPanTilt.cpp */
/* XXInitialValue is model specific and therefore implemented in ControllerPanTilt.cpp */
...
/* XXStopSimulation is implemented in ControllerPanTilt.cpp */
