...
/* This file describes the model functions
   ...
   The model itself is the ControllerPanTilt.cpp file
*/
#ifndef ControllerPanTilt_H
#define ControllerPanTilt_H
...
class ControllerPanTilt: virtual public Submodel20sim
{
	public:
		enum stateflags_ControllerPanTilt {initialrun, mainrun, finished};

		/**
		 * ControllerPanTilt constructor
		 */
		ControllerPanTilt(void);

		/**
		 * ControllerPanTilt destructor
		 */
		virtual ~ControllerPanTilt(void);

		/**
		 * ControllerPanTilt Initialization of the model and calculation of the values for the start time t
		...
		stateflags_ControllerPanTilt state;
